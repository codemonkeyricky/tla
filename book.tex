...
The Raft protocol implements a few key tenent principles. Here we refer the cluster 
of nodes as the \textit{system}:
\begin{itemize}
    \item A Raft cluster have N nodes 
    ...
    \textit{system} will persist (and possibly correct and re-replicate) all
