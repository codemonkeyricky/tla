...
\@x{ Liveness \.{\defeq}}%
\@x{\@s{16.4} \.{\land} c [ 1 ] \.{=} 0 \.{\leadsto} c [ 1 ] \.{=} 1}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} c \.{=} [ i \.{\in} 1 \.{\dotdot} 2 \.{\mapsto} 0 ]}%
\@x{ BumpOne \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ 1 ] \.{=} ( c [
 1 ] \.{+} 1 ) \.{\%} 2 ]}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} BumpOne}%
\@x{ Spec \.{\defeq}}%
\@x{\@s{8.2} \.{\land}\@s{0.16} Init}%
\@x{\@s{8.2} \.{\land}\@s{0.16} {\Box} [ Next ]_{ vars}}%
\@x{}\bottombar\@xx{}%
...
\@x{ BumpOne \.{\defeq}}%
 ...
 1 ] \.{+} 1 ) \.{\%} 2 ]}%
\@x{ BumpTwo \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ 2 ] \.{=} ( c [
 2 ] \.{+} 1 ) \.{\%} 2 ]}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} BumpOne}%
\@x{\@s{16.4} \.{\lor} BumpTwo}%
\@x{ Spec \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Init}%
\@x{\@s{16.4} \.{\land} {\Box} [ Next ]_{ vars}}%
