...
\end{tlatex}
Which states the only valid value of b is 0 or 1. If b is ever set to anything
...
the spec. Some possible liveness properties include: A consensus protocol
eventually converges, all indices are eventually used in a lockless
queue, all tasks are eventually scheduled by the scheduler, etc. 
