...
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\IF} meta\_server [ f ] \.{<} client\_meta [ k ] [ f
 ] \.{\THEN}}%
\@x{\@s{20.5}}%
\@y{%
  are we ahead? 
...
\@xx{}%
\@x{\@s{20.5} {\IF} client\_change [ k ] [ f ] \.{\THEN}}%
\@x{\@s{24.6}}%
\@y{%
  something to upload
}%
\@xx{}%
\@x{\@s{24.6} \.{\land} meta\_server \.{'}}%
...
\@x{\@s{24.6} \.{\land} client\_change \.{'}}%
\@x{\@s{28.7} \.{=} [ client\_change {\EXCEPT} {\bang} [ k ]}%
 \@x{\@s{32.8} \.{=} [ client\_change [ k ] {\EXCEPT} {\bang} [ f ] \.{=}
 {\FALSE} ] ]}%
 \@x{\@s{24.6} \.{\land} {\UNCHANGED} {\langle} client\_block ,\, client\_meta
 {\rangle}}%
\@x{\@s{20.5} \.{\ELSE}}%
\@x{\@s{36.9}}%
\@y{%
...
\@xx{}%
\@x{\@s{20.5} \.{\land} SyncMeta ( k ,\, f )}%
 \@x{\@s{20.5} \.{\land} {\UNCHANGED} {\langle} meta\_server ,\, block\_server
 {\rangle}}%
\end{tlatex}
\\
