...
\@x{}\moduleLeftDash\@xx{ {\MODULE} raft\_vote}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, FiniteSets ,\, TLC}%
 \@x{ {\VARIABLES} state ,\, messages ,\, voted\_for ,\, vote\_granted ,\,
 vote\_received ,\, term}%
 \@x{ vars \.{\defeq} {\langle} state ,\, messages ,\, voted\_for ,\, term ,\,
 vote\_granted ,\, vote\_received {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{Follower \.{\defeq} 0
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{Candidate \.{\defeq} 1
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{Leader \.{\defeq} 2
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Servers \.{\defeq} \{\@w{s0} ,\,\@w{s1} ,\,\@w{s2} \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} state \.{=} [ s \.{\in} Servers
 \.{\mapsto}\@w{Follower} ]}%
\@x{\@s{16.4} \.{\land} messages \.{=} [ m \.{\in} \{ \} \.{\mapsto} 0 ]}%
 \@x{\@s{16.4} \.{\land} voted\_for \.{=} [ s \.{\in} Servers \.{\mapsto}\@w{}
 ]}%
 \@x{\@s{16.4} \.{\land} vote\_received \.{=} [ s \.{\in} Servers \.{\mapsto}
 \{ \} ]}%
...
\@x{\@s{16.4} {\IF} to\_add \.{\in} {\DOMAIN} msgs \.{\THEN}}%
\@x{\@s{32.65} [ msgs {\EXCEPT} {\bang} [ to\_add ] \.{=} @ \.{+} 1 ]}%
\@x{\@s{16.4} \.{\ELSE}}%
\@x{\@s{32.8} msgs \.{\,@@\,} ( to\_add \.{\colongt} 1 )}%
\@pvspace{8.0pt}%
\@x{ RemoveMessage ( to\_remove ,\, msgs ) \.{\defeq}}%
\@x{\@s{16.4} {\IF} to\_remove \.{\in} {\DOMAIN} msgs \.{\THEN}}%
 \@x{\@s{32.65} {\IF} msgs [ to\_remove ] \.{\leq} 1 \.{\THEN} [ i \.{\in}
 {\DOMAIN} msgs \.{\,\backslash\,} \{ to\_remove \} \.{\mapsto} msgs [ i ] ]}%
 \@x{\@s{32.65} \.{\ELSE} [ msgs {\EXCEPT} {\bang} [ to\_remove ] \.{=} msgs [
 to\_remove ] \.{-} 1 ]}%
\@x{\@s{16.4} \.{\ELSE}}%
\@x{\@s{32.8} msgs}%
\@pvspace{8.0pt}%
\@x{ KeepAlive ( i ,\, j ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} messages \.{'} \.{=} AddMessage ( [ fSrc \.{\mapsto}
 i ,\,}%
\@x{\@s{43.91} fDst \.{\mapsto} j ,\,}%
\@x{\@s{43.91} fType\@s{2.95} \.{\mapsto}\@w{AppendEntryReq} ,\,}%
\@x{\@s{43.91} fTerm \.{\mapsto} term [ i ] ] ,\, messages )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} vars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Timeout ( i ) \.{\defeq}}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{9.72} vote\_received \.{'} \.{=} [ vote\_received
 {\EXCEPT} {\bang} [ i ] \.{=} \{ i \} ]}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} PrintT(state\.{'})
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Campaign ( i ,\, j ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} j \.{\notin} vote\_received [ i ]}%
 \@x{\@s{16.4} \.{\land} messages \.{'} \.{=} AddMessage ( [ fSrc \.{\mapsto}
 i ,\,}%
\@x{\@s{148.54} fDst \.{\mapsto} j ,\,}%
\@x{\@s{148.54} fType\@s{2.95} \.{\mapsto}\@w{RequestVoteReq} ,\,}%
\@x{\@s{148.54} fTerm \.{\mapsto} term [ i ] ] ,\, messages )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} state ,\, term ,\,
 vote\_granted ,\, vote\_received ,\, voted\_for {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{32.8}}%
\@y{\@s{0}%
 haven\mbox{'}t voted, or whom we voted re-requested
}%
\@xx{}%
\@x{\@s{32.8} \.{\lor} \.{\land} t \.{=} term [ i ]}%
 \@x{\@s{43.91} \.{\land} voted\_for [ i ] \.{=} j \.{\lor} voted\_for [ i ]
 \.{=}\@w{}}%
...
\@x{\@s{180.15} RemoveMessage ( msg ,\, messages ) )}%
 \@x{\@s{43.91} \.{\land} {\UNCHANGED} {\langle} state ,\, voted\_for ,\, term
 ,\, vote\_granted ,\, vote\_received {\rangle}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
...
\@x{\@s{180.15} fSuccess \.{\mapsto} 1 ] ,\,}%
\@x{\@s{180.15} RemoveMessage ( msg ,\, messages ) )}%
 \@x{\@s{48.01} \.{\land} {\UNCHANGED} {\langle} vote\_granted ,\,
 vote\_received {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AppendEntryRespProc ( msg ) \.{\defeq}}%
\@x{\@s{16.4} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{ RequestVoteReplyProc ( msg ) \.{\defeq}}%
\@x{\@s{16.4} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{ RequestVoteResp ( msg ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET}}%
\@x{\@s{32.8} i\@s{0.42} \.{\defeq} msg . fDst}%
\@x{\@s{32.8} j \.{\defeq} msg . fSrc}%
\@x{\@s{32.8} type \.{\defeq} msg . fType}%
\@x{\@s{32.8} t\@s{0.63} \.{\defeq} msg . fTerm}%
\@x{\@s{32.8} s \.{\defeq} msg . fSuccess}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 same term success
...
\@xx{}%
\@x{\@s{32.8} \.{\lor} \.{\land} t\@s{0.63} \.{=} term [ i ]}%
\@x{\@s{43.91} \.{\land} s \.{=} 1}%
 \@x{\@s{43.91} \.{\land} vote\_granted \.{'} \.{=} [ vote\_granted {\EXCEPT}
 {\bang} [ i ] \.{=} @ \.{\cup} \{ j \} ]}%
 \@x{\@s{43.91} \.{\land} vote\_received \.{'} \.{=} [ vote\_received
 {\EXCEPT} {\bang} [ i ] \.{=} @ \.{\cup} \{ j \} ]}%
 \@x{\@s{43.91} \.{\land} {\UNCHANGED} {\langle} state ,\, voted\_for ,\, term
 ,\, messages {\rangle}}%
\@x{\@s{32.8}}%
...
\@x{\@s{43.91} \.{\land} s \.{=} 0}%
 ...
 {\EXCEPT} {\bang} [ i ] \.{=} @ \.{\cup} \{ j \} ]}%
 \@x{\@s{43.91} \.{\land} {\UNCHANGED} {\langle} state ,\, voted\_for ,\, term
 ,\, vote\_granted ,\, messages {\rangle}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 response has smaller \ensuremath{term \.{-}} ignore
}%
\@xx{}%
\@x{\@s{32.8} \.{\lor} \.{\land} t \.{<} term [ i ]}%
 \@x{\@s{43.91} \.{\land} messages \.{'} \.{=} RemoveMessage ( msg ,\,
 messages )}%
 \@x{\@s{43.91} \.{\land} {\UNCHANGED} {\langle} state ,\, voted\_for ,\, term
 ,\, vote\_granted ,\, vote\_received {\rangle}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 response has higher \ensuremath{term \.{-}} become follower
}%
\@xx{}%
\@x{\@s{32.8} \.{\lor} \.{\land} t \.{>} term [ i ]}%
 \@x{\@s{43.91} \.{\land} messages \.{'} \.{=} RemoveMessage ( msg ,\,
 messages )}%
 \@x{\@s{43.91} \.{\land} state \.{'} \.{=} [ state {\EXCEPT} {\bang} [ i ]
 \.{=}\@w{Follower} ]}%
 ...
 \@x{\@s{43.91} \.{\land} vote\_granted \.{'} \.{=} [ vote\_granted {\EXCEPT}
 {\bang} [ i ] \.{=} \{ \} ]}%
 \@x{\@s{43.91} \.{\land} term \.{'} \.{=} [ term {\EXCEPT} {\bang} [ i ]
 \.{=} t ]}%
\@pvspace{8.0pt}%
\@x{ Receive ( msg ) \.{\defeq}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor} AppendEntryReq(msg)
}}%
\@xx{}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor} AppendEntryRespProc(msg)
}}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} \.{\land} msg . fType \.{=}\@w{RequestVoteReq}}%
\@x{\@s{27.51} \.{\land} RequestVoteReq ( msg )}%
\@x{\@s{16.4} \.{\lor} \.{\land} msg . fType \.{=}\@w{RequestVoteResp}}%
\@x{\@s{27.51} \.{\land} RequestVoteResp ( msg )}%
\@pvspace{8.0pt}%
\@x{ LeaderProc ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} state [ i ] \.{=}\@w{Leader}}%
 \@x{\@s{16.4} \.{\land} \E\, j \.{\in} Servers \.{\,\backslash\,} \{ i \}
 \.{:} KeepAlive ( i ,\, j )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{ BecomeLeader ( i ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} Cardinality ( vote\_received [ i ] ) \.{>}
 Cardinality ( Servers ) \.{\div} 2}%
 \@x{\@s{16.4} \.{\land} state \.{'} \.{=} [ state {\EXCEPT} {\bang} [ i ]
 \.{=}\@w{Leader} ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} messages ,\, voted\_for ,\,
 term ,\, vote\_granted ,\, vote\_received {\rangle}}%
\@pvspace{8.0pt}%
\@x{ CandidateProc ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \.{\land} state [ i ] \.{=}\@w{Candidate}}%
\@x{\@s{27.51} \.{\land} \E\, j \.{\in} Servers \.{:} Campaign ( i ,\, j )}%
\@x{\@s{16.4} \.{\lor} \.{\land} state [ i ] \.{=}\@w{Candidate}}%
\@x{\@s{27.51} \.{\land} BecomeLeader ( i )}%
\@pvspace{8.0pt}%
\@x{ FollowerProc ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} state [ i ] \.{=}\@w{Follower}}%
\@x{\@s{16.4} \.{\land} Timeout ( i )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \E\, i \.{\in} Servers \.{:} LeaderProc ( i )}%
\@x{\@s{16.4} \.{\lor} \E\, i \.{\in} Servers \.{:} CandidateProc ( i )}%
\@x{\@s{16.4} \.{\lor} \E\, i \.{\in} Servers \.{:} FollowerProc ( i )}%
 \@x{\@s{16.4} \.{\lor} \E\, msg \.{\in} {\DOMAIN} messages \.{:} Receive (
 msg )}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq}}%
