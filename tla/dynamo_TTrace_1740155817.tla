---- MODULE dynamo_TTrace_1740155817 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("dynamo_TTrace_1740155817.json", _TETrace)
...
\*
\*trace == IODeserialize("dynamo_TTrace_1740155817.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([local_ring |-> [n0 |-> [n0 |-> [version |-> 0, token |-> 0, status |-> 0], n1 |-> [version |-> 0, token |-> 0, status |-> 0], n2 |-> [version |-> 0, token |-> 0, status |-> 0]], n1 |-> [n0 |-> [version |-> 0, token |-> 0, status |-> 0], n1 |-> [version |-> 0, token |-> 0, status |-> 0], n2 |-> [version |-> 0, token |-> 0, status |-> 0]], n2 |-> [n0 |-> [version |-> 0, token |-> 0, status |-> 0], n1 |-> [version |-> 0, token |-> 0, status |-> 0], n2 |-> [version |-> 0, token |-> 0, status |-> 0]]],cluster |-> {},debug |-> {},local_kv |-> [n0 |-> {}, n1 |-> {}, n2 |-> {}],global_kv |-> {},global_ring |-> <<>>]),
...
---- CONFIG dynamo_TTrace_1740155817 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Feb 21 08:36:58 PST 2025