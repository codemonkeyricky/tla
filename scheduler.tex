...
acquire the lock and run. However, before we describe this liveness property, we
first need to make sure lock holder \textit{cannot} hold onto the lock
indefinitely. This is described as a fairness requirement:\newline
