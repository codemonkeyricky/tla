...
space, and context switching process requires the OS to "clean" the hardware
...
their own runtime. The runtime must also include a scheduler to manage the
...
\begin{itemize}
    ...
    \item Tasks have identical priority and are scheduled cooperatively.
