...
\@x{}\moduleLeftDash\@xx{ {\MODULE} lockless}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} TLC ,\, Naturals ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} M ,\, N ,\, Reader ,\, Writer\@s{4.1}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
 \@x{\@s{16.4} buffer ,\, read\_state ,\, write\_state ,\, wptr ,\, read\_cnt
 ,\, rptr\_next ,\, rptr\_local ,\, rptr}%
\@pvspace{16.0pt}%
 \@x{ read\_var \.{\defeq} {\langle} read\_state ,\, rptr ,\, rptr\_next ,\,
 read\_cnt ,\, rptr\_local {\rangle}}%
\@x{ write\_var \.{\defeq} {\langle} write\_state ,\, wptr {\rangle}}%
\@x{ common\_var \.{\defeq} {\langle} buffer {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 {\par}\cdash{77}
...
\@xx{}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} buffer \.{=} [ i \.{\in} 0 \.{\dotdot} N \.{-} 1
 \.{\mapsto} 1 ]}%
 \@x{\@s{16.4} \.{\land} read\_cnt \.{=} [ i \.{\in} 0 \.{\dotdot} N \.{-} 1
 \.{\mapsto} 0 ]}%
 \@x{\@s{16.4} \.{\land} rptr\_local \.{=} [ i \.{\in} 0 \.{\dotdot} Reader
 \.{-} 1 \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} rptr\_next \.{=} 0}%
\@x{\@s{16.4} \.{\land} rptr\@s{2.42} \.{=} 0}%
\@x{\@s{16.4} \.{\land} wptr \.{=} 0}%
 \@x{\@s{16.4} \.{\land} read\_state \.{=} [ i \.{\in} 0 \.{\dotdot} Reader
 \.{-} 1 \.{\mapsto}\@w{read\_init} ]}%
\@x{\@s{16.4} \.{\land} write\_state \.{=}\@w{write\_init}}%
\@pvspace{8.0pt}%
\@x{ write\_init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} write\_state \.{=}\@w{write\_init}}%
\@x{\@s{16.4} \.{\land} ( ( wptr \.{+} 1 ) \.{\%} N ) \.{\neq} rptr}%
\@x{\@s{16.4} \.{\land} write\_state \.{'} \.{=}\@w{write\_data}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} read\_var ,\, common\_var ,\,
 wptr {\rangle}}%
\@pvspace{8.0pt}%
\@x{ write\_data \.{\defeq}}%
\@x{\@s{16.4} \.{\land} write\_state \.{=}\@w{write\_data}}%
 \@x{\@s{16.4} \.{\land} buffer \.{'} \.{=} [ buffer {\EXCEPT} {\bang} [ wptr
 ] \.{=} 1 ]}%
\@x{\@s{16.4} \.{\land} write\_state \.{'} \.{=}\@w{write\_update\_wptr}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} read\_var ,\, wptr {\rangle}}%
\@pvspace{8.0pt}%
\@x{ write\_update\_wptr \.{\defeq}}%
\@x{\@s{16.4} \.{\land} write\_state \.{=}\@w{write\_update\_wptr}}%
\@x{\@s{16.4} \.{\land} wptr \.{'} \.{=} ( wptr \.{+} 1 ) \.{\%} N}%
\@x{\@s{16.4} \.{\land} write\_state \.{'} \.{=}\@w{write\_init}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} read\_var ,\, common\_var
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ write \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} write\_init}%
\@x{\@s{16.4} \.{\lor} write\_data}%
\@x{\@s{16.4} \.{\lor} write\_update\_wptr}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 reserve index to read and bump \ensuremath{read\_next
}}%
\@xx{}%
\@x{ read\_init ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} read\_state [ i ] \.{=}\@w{read\_init}}%
\@x{\@s{16.4} \.{\land} rptr\_next \.{\neq} wptr}%
 \@x{\@s{16.4} \.{\land} rptr\_local \.{'} \.{=} [ rptr\_local {\EXCEPT}
 {\bang} [ i ] \.{=} rptr\_next ]}%
 \@x{\@s{16.4} \.{\land} rptr\_next \.{'} \.{=} ( rptr\_next \.{+} 1 ) \.{\%}
 N}%
 \@x{\@s{16.4} \.{\land} read\_state \.{'} \.{=} [ read\_state {\EXCEPT}
 {\bang} [ i ] \.{=}\@w{read\_data} ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} write\_var ,\, common\_var ,\,
 rptr ,\, read\_cnt {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 read data
...
\@xx{}%
\@x{ read\_data ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET}}%
\@x{\@s{32.8} k \.{\defeq} rptr\_local [ i ]}%
\@x{\@s{32.8} cnt \.{\defeq} read\_cnt [ k ]}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 read and bump the read count
}%
\@xx{}%
\@x{\@s{32.8} \.{\land} read\_state [ i ] \.{=}\@w{read\_data}}%
 \@x{\@s{32.8} \.{\land} read\_cnt \.{'} \.{=} [ read\_cnt {\EXCEPT} {\bang} [
 k ] \.{=} ( read\_cnt [ k ] \.{+} 1 ) \.{\%} M ]}%
 \@x{\@s{32.8} \.{\land} read\_state \.{'} \.{=} [ read\_state {\EXCEPT}
 {\bang} [ i ] \.{=}\@w{read\_update\_rptr} ]}%
 \@x{\@s{32.8} \.{\land} buffer \.{'} \.{=} [ buffer {\EXCEPT} {\bang} [ k ]
 \.{=} 0 ]}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} write\_var ,\, rptr ,\,
 rptr\_next ,\, rptr\_local {\rangle}}%
\@x{\@s{32.8} \.{\land} PrintT ( read\_cnt )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 attempt to recycle
...
\@xx{}%
\@x{ read\_update\_rptr ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET}}%
\@x{\@s{32.8} expected \.{\defeq} read\_cnt [ rptr\_local [ i ] ]}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{32.8} \.{\land} read\_state [ i ] \.{=}\@w{read\_update\_rptr}}%
\@x{\@s{32.8} \.{\land} rptr \.{\neq} rptr\_next}%
\@x{\@s{32.8} \.{\land} read\_cnt [ rptr ] \.{=} expected}%
\@x{\@s{32.8} \.{\land} rptr \.{'} \.{=} ( rptr \.{+} 1 ) \.{\%} N}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} write\_var ,\, common\_var ,\,
 rptr\_next ,\,\@s{4.1} rptr\_local ,\, read\_cnt ,\, read\_state {\rangle}}%
\@pvspace{8.0pt}%
\@x{ read\_update\_rptr2 ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET}}%
\@x{\@s{32.8} expected \.{\defeq} read\_cnt [ rptr\_local [ i ] ]}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{32.8} \.{\land} read\_state [ i ] \.{=}\@w{read\_update\_rptr}}%
\@x{\@s{32.8} \.{\land} \.{\lor} rptr \.{=} rptr\_next\@s{69.7}}%
\@y{\@s{0}%
 we are caught up
}%
\@xx{}%
\@x{\@s{43.91} \.{\lor} read\_cnt [ rptr ] \.{\neq} expected\@s{16.4}}%
\@y{\@s{0}%
 another reader is still reading
}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} read\_state \.{'} \.{=} [ read\_state {\EXCEPT}
 {\bang} [ i ] \.{=}\@w{read\_init} ]}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} write\_var ,\, common\_var ,\,
 rptr\_next ,\,\@s{4.1} rptr\_local ,\, read\_cnt ,\, rptr {\rangle}}%
\@pvspace{8.0pt}%
\@x{ read ( i ) \.{\defeq}}%
\@x{\@s{19.04} \.{\lor} read\_init ( i )}%
\@x{\@s{19.04} \.{\lor} read\_data ( i )}%
\@x{\@s{19.04} \.{\lor} read\_update\_rptr ( i )}%
\@x{\@s{19.04} \.{\lor} read\_update\_rptr2 ( i )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} write}%
 \@x{\@s{16.4} \.{\lor} \E\, i \.{\in} 0 \.{\dotdot} Reader \.{-} 1 \.{:} read
 ( i )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Spec \.{\defeq}}%
 \@x{\@s{16.4} Init \.{\land} {\Box} [ Next ]_{ {\langle} common\_var ,\,
 read\_var ,\, write\_var {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{TODO}: invariant \ensuremath{\.{-} read} and write pointer
 within bound
}%
\@xx{}%
\@pvspace{8.0pt}%
